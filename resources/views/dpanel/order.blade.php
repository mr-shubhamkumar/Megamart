...
@section('body_content')
    <div class="grid grid-cols-1 md:grid-cols-3 rounded-l pl-2 mb-3 text-white">
        ...
        <p>Order Status: <span class="font-medium"><select onchange="updateStatus(this, '{{ $order->id }}')"
                                                           class="bg-gray-700 border rounded focus:outline-none">
                            ...
                            <tr>
                                ...
                                <td class="pl-3 py-3">
                                    <div class="text-sm text-gray-200 flex items-center gap-2">
                                        ...
                                        <span class="w-4 h-4 rounded-full flex"
                                              style="background-color: {{ $item->variant->color->code }}">&nbsp;</span>
                                    </div>
                                </td>
                                <td class="pl-3 py-3">
                                    <div class="text-sm text-gray-200">{{ $item->variant->size->name }}
