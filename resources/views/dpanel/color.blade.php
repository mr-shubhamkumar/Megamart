        ...
        <form id="edit-form" action="" method="post">
            ...
            <div class=" grid grid-cols-1 gap-3">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="color-name" maxlength="255" required placeholder="Enter color Name
                    " class="w-full bg-transparent border border-gray-500 rounded px-2 focus:outline-none">
                </div>
                <div>
                    <label for="">Code</label>
                    <input type="color" name="code" id="color-code" maxlength="255" required placeholder="Enter color Name
                    " class="w-full bg-transparent border border-gray-500 rounded px-2 focus:outline-none">
                </div>
                <div>
