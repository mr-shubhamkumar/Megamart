    ...
    <script>
        ...
        const setEmptyView = () => {
            document.getElementById('itemContainer').innerHTML = `<div class="md:col-span-2 flex flex-col gap-2 justify-center items-center">
                        ...
                        <p class="text-gray-400 text-center">Looks like you have't not added anything on your cart</p><a href="{{ route('products') }}"
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="md:col-span-2 ">
                ...
                <div class=" grid grid-cols-1 md:grid-cols-6 gap-4 mb-5">
                    ...
                    <div
                        id="addresses"class="md:col-span-5 flex gap-4 overflow-x-auto pt-0 pb-0.5 scrollbar-thin scrollbar-thumb-gray-400 scrollbar-h-1">
                        ...
                        @forelse ($address as $item)
                            <label class="shrink-0 w-72 relative " for="address_{{ $item->id }}">
                                ...
                                <div
                                    ...
                                    <p class="text-gray-400 leading-4 text-sm">
                                        {{ $item->street_address . ' ' . $item->district . ' ' . $item->state . ' ' . $item->pin_code }}
                                    </p>
                ...
                <div id="itemContainer" class="grid grid-cols-1 md:grid-cols-2 gap-5 ">
                    <div class="md:col-span-2 flex flex-col gap-2 justify-center items-center">
                        <img src="{{ asset('images/result-not-found.png') }}" alt="">
                        <h2 class="text-2xl font-bold text-gray-800">Your Cart is Empty</h2>
                        <p class="text-gray-400 text-center">Looks like you have't not added anything on your cart</p>
                    </div>
                </div>
            </div>
            {{-- Left Side End --}}
