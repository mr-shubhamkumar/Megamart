...
<main>
    ...
    <div id="login-popup" class="absolute
        ...
        <form action="" method="post" id="login" class="grid grid-cols-1 gap-3 p-2">
            ...
            <button type="button" onclick="toggleForms('register')" class="text-sm text-gray-400 ">Don't have an account
        ...
        <form action="" method="post" id="register" class="grid capitalize grid-cols-1 gap-3 p-2 hidden">
            ...
            <button type="button" onclick="register()" class="bg-violet-500 mt-4 text-white font-medium py-1 rounded">
                Register
            </button>
        ...
        <form action="" method="post" id="forgot" class="grid grid-cols-1 gap-3 p-2 hidden">
            ...
            <button type="button" onclick="forgot()" class="bg-violet-500 mt-4 text-white font-medium py-1 rounded">Send
                Reset Link
            </button>
